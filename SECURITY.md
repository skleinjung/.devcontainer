...
The toolkit's [tier *concept*](https://github.com/twin-digital/opus/blob/main/nodejs/devcontainer/credential-shelf/docs/SECURITY.md#2-trust-tiers--the-concept),
instantiated here:
...
[SECURITY.md §11](https://github.com/twin-digital/opus/blob/main/nodejs/devcontainer/credential-shelf/docs/SECURITY.md#11-human-discipline-the-patterns-depend-on-these).
...
- **Privileged ops (`terraform`/`deploy`/`lpass`) don't run in a local sidecar.** The
  ...
  "applying agent output re-crosses the boundary"](https://github.com/twin-digital/opus/blob/main/nodejs/devcontainer/credential-shelf/docs/SECURITY.md#3-what-this-does-not-protect)).
...
([§13](https://github.com/twin-digital/opus/blob/main/nodejs/devcontainer/credential-shelf/docs/SECURITY.md#13-invariants-dont-regress-these)), with the
